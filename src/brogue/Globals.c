...
const checkpointText *checkpointTexts;
...
creatureType monsterCatalog[NUMBER_MONSTER_KINDS] = {
    ...
    {0, "Sewer Rat",          G_RAT,    &gray,          6,      0,      80,     {1, 3, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      1,      DF_URINE,       {0}},
    {0, "Shed-Katan",       G_KOBOLD,    &goblinColor,   7,      0,      80,     {1, 4, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      0,      0,              {0}},
    {0, "Midbar Jackal",       G_JACKAL,    &jackalColor,   8,      0,      70,     {2, 4, 1},      20, 50,     100,    DF_RED_BLOOD,   0,    false,      1,      DF_URINE,              {0}},
    ...
    {0, "pit bloat",    G_BLOAT,    &lightBlue,     4,      0,      100,    {0, 0, 0},      5,  100,    100,    DF_PURPLE_BLOOD,0,    false,      0,      DF_HOLE_POTION, {0},
        (MONST_FLIES | MONST_FLITS), (MA_KAMIKAZE | MA_DF_ON_DEATH)},
    {0, "Shed",       G_GOBLIN,    &goblinColor,   15,     10,     70,     {2, 5, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      0,      0,              {0},
        (0),  (MA_ATTACKS_PENETRATE | MA_AVOID_CORRIDORS)},
    {0, "Shed-Keshet",G_GOBLIN_MAGIC,  &goblinConjurerColor, 10,10,    70,     {2, 4, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      0,      0,              {0},
        (MONST_MAINTAINS_DISTANCE | MONST_CAST_SPELLS_SLOWLY | MONST_CARRY_ITEM_25), (MA_CAST_SUMMON | MA_AVOID_CORRIDORS)},
    {0, "Shed-Mekhashaf",G_GOBLIN_MAGIC,    &goblinMysticColor, 10, 10,     70,     {2, 4, 1},      20, 100,    100,    DF_RED_BLOOD,   0,    false,      0,      0,              {BOLT_SHIELDING},
    ...
    {0, "Tehom Slime",   G_JELLY,    &pinkJellyColor,50,     0,      85,     {1, 3, 1},      0,  100,    100,    DF_PURPLE_BLOOD,0,    true,       0,      0,              {0},
    ...
    {0, "Layl-Bat",  G_BAT,    &gray,          18,     25,     100,    {2, 6, 1},      20, 50,     100,    DF_RED_BLOOD,   0,    false,      0,      0,              {0},
    ...
    {0, "Shed-Gadol",         G_OGRE,    &ogreColor,     55,     60,     125,    {9, 13, 2},     20, 100,    200,    DF_RED_BLOOD,   0,    true,       0,      0,              {0},
    ...
    {0, "ogre totem",   G_TOTEM, &green,     70,     0,      0,      {0, 0, 0},      0,  100,    400,    DF_RUBBLE_BLOOD,LICH_LIGHT,    false,0,   0,              {BOLT_HEALING, BOLT_SLOW_2},
        (MONST_IMMUNE_TO_WEBS | MONST_NEVER_SLEEPS | MONST_IMMOBILE | MONST_INANIMATE | MONST_WILL_NOT_USE_STAIRS), (0)},
    {0, "Kuriat",       G_SPIDER,    &white,         20,     70,     90,     {3, 4, 2},      20, 100,    200,    DF_GREEN_BLOOD, 0,    false,      0,      0,              {BOLT_SPIDERWEB},
    ...
    {0, "Ruach Teme'ah",       G_WRAITH,    &wraithColor,   50,     60,     120,    {6, 13, 2},     5,  50,     100,    DF_GREEN_BLOOD, 0,    true,       0,      0,              {0},
        (MONST_FLEES_NEAR_DEATH)},
    {0, "Golem Shevur",       G_ZOMBIE,    &vomitColor,    80,     0,      120,    {7, 12, 1},     0,  100,    100,    DF_ROT_GAS_BLOOD,0,    true,      100,    DF_ROT_GAS_PUFF, {0}},
    {0, "Anak Shevur",        G_TROLL,    &trollColor,    65,     70,     125,    {10, 15, 3},    1,  100,    100,    DF_RED_BLOOD,   0,    true,       0,      0,              {0},
        (MONST_MALE | MONST_FEMALE)},
    ...
    {0, "Nachash Atik",         G_NAGA,    &trollColor,    75,     70,     150,    {7, 11, 4},     10, 100,    100,    DF_GREEN_BLOOD, 0,    true,       100,    DF_PUDDLE,      {0},
        (MONST_IMMUNE_TO_WATER | MONST_SUBMERGES | MONST_NEVER_SLEEPS | MONST_FEMALE), (MA_ATTACKS_ALL_ADJACENT)},
    {0, "Saraf Katan",   G_SALAMANDER,    &salamanderColor,60,    70,     150,    {5, 11, 3},     10, 100,    100,    DF_ASH_BLOOD,   SALAMANDER_LIGHT,    true,  100, DF_SALAMANDER_FLAME, {0},
    ...
    {0, "Tehom Slime (Acidic)", G_JELLY,    &acidBackColor, 60,     0,      115,    {2, 6, 1},      0,  100,    100,    DF_ACID_BLOOD,  0,    true,       0,      0,              {0},
        (MONST_DEFEND_DEGRADE_WEAPON), (MA_HIT_DEGRADE_ARMOR | MA_CLONE_SELF_ON_DEFEND)},
    {0, "Ish-Behema",      G_CENTAUR,    &tanColor,      35,     50,     175,    {4, 8, 2},      20, 50,     100,    DF_RED_BLOOD,   0,    true,       0,      0,              {BOLT_DISTANCE_ATTACK},
    ...
    {0, "underworm",    G_UNDERWORM,    &wormColor,     80,     40,     160,    {18, 22, 2},    3,  150,    200,    DF_WORM_BLOOD,  0,    true,       0,      0,              {0},
        (MONST_NEVER_SLEEPS)},
    {0, "Shomer HaSha'ar",     G_GUARDIAN, &sentinelColor, 50,0,      0,      {0, 0, 0},      0,  100,    175,    DF_RUBBLE_BLOOD,SENTINEL_LIGHT,    false,0,0,             {BOLT_HEALING, BOLT_SPARK},
    ...
    {0, "Tannin",       G_KRAKEN,    &krakenColor,   120,    0,      150,    {15, 20, 3},    1,  50,     100,    0,              0,    true,       0,      0,              {0},
    ...
    {0, "Baal-Shem Tameh",         G_LICH,    &white,         35,     80,     175,    {2, 6, 1},      0,  100,    100,    DF_ASH_BLOOD,   LICH_LIGHT,    true,  0,  0,              {BOLT_FIRE},
    ...
    {0, "Ruach Hester",      G_PHANTOM,    &ectoplasmColor,35,     70,     160,    {12, 18, 4},    0,  50,     200,    DF_ECTOPLASM_BLOOD, 0,    true,   2,      DF_ECTOPLASM_DROPLET, {0},
    ...
    {0, "Met SheLo Nach",     G_REVENANT,    &ectoplasmColor,30,     0,      200,    {15, 20, 5},    0,  100,    100,    DF_ECTOPLASM_BLOOD, 0,    true,   0,      0,              {0},
    ...
    {0, "Saraf",       G_DRAGON,    &dragonColor,   150,    90,     250,    {25, 50, 4},    20, 50,     200,    DF_GREEN_BLOOD, 0,    true,       0,      0,              {BOLT_DRAGONFIRE},
    ...
    {0, "Tehom Slime (Black)",  G_JELLY,    &black,         120,    0,      130,    {3, 8, 1},      0,  100,    100,    DF_PURPLE_BLOOD,0,    true,       0,      0,              {0},
        (0), (MA_CLONE_SELF_ON_DEFEND)},
    {0, "Ben-Layla",      G_VAMPIRE,    &white,         75,     60,     120,    {4, 15, 2},     6,  50,     100,    DF_RED_BLOOD,   0,    true,       0,      DF_BLOOD_EXPLOSION, {BOLT_BLINKING, BOLT_DISCORD},
    ...
    {0, "Shomer HaSha'ar (Stone)",G_GUARDIAN, &white,   1000,   0,      200,    {12, 17, 2},    0,  100,    100,    DF_RUBBLE,      0,    false,      100,      DF_GUARDIAN_STEP, {0},
    ...
    {0, "Shomer HaSha'ar (Winged)",G_WINGED_GUARDIAN, &blue,   1000,   0,      200,    {12, 17, 2},    0,  100,    100,    DF_RUBBLE,      0,    false,      100,      DF_SILENT_GLYPH_GLOW, {BOLT_BLINKING},
    ...
    {0, "Shomer HaSha'ar (Spirit)",G_GUARDIAN, &spectralImageColor,1000,0,200,  {5, 12, 2},     0,  100,    100,    0,              SPECTRAL_IMAGE_LIGHT,    false,100,0,     {0},
    ...
    {0, "Malach Shevur",G_WARDEN, &yendorLightColor,1000,   0,    300,    {12, 17, 2},    0,  200,    200,    DF_RUBBLE,      YENDOR_LIGHT,    true,  100, 0,           {0},
    ...
    {0, "Of-Ash",      G_PHOENIX,    &phoenixColor,  30,     70,     175,    {4, 10, 2},     0,  50,     100,    DF_ASH_BLOOD,   PHOENIX_LIGHT,    true, 0,0,              {0},
...
const monsterWords monsterText[NUMBER_MONSTER_KINDS] = {
    ...
    {"Shedim have fashioned this crude idol of bone and stone, imbuing the Tzelem with primitive faith. $HESHE channels shamanistic power to bolster $HISHER kin.",
        "gazing at", "Gazing",
        {"hits", {0}}},
    ...
    {"Shedim have assembled this great idol and carved twisted verses into $HISHER surface. The Tzelem Gadol is an instrument of occult dominion, $HISHER runes pulsing with eldritch light.",
        "gazing at", "Gazing",
        {"hits", {0}}},
    ...
    {"This contraption hums with electrical charge that $HISHER embedded crystals and magical sigils can direct at intruders in deadly arcs.",
        "gazing at", "Gazing",
        {"shocks", {0}}},
    {"The Lahat is a wandering flame from the boundary between worlds, flickering and pulsing in time to an otherworldly rhythm. Like the flaming sword of the cherubim, $HESHE scorches all who draw too close.",
        "consuming", "Feeding",
        {"scorches", "burns", {0}}},
    ...
    {"This ancient Shed Mezamen has traded physical might for occult mastery, $HISHER body bent with age and dark knowledge. $HESHE chants incantations in a guttural tongue and calls upon infernal forces to destroy those who oppose $HIMHER.",
        "performing a ritual on", "Performing ritual",
        {"cudgels", "clubs", {0}},
        {0},
    ...
    {"Born of Lilith's bloodline, the Ben Lilith is swift and lethal, leaping toward $HISHER enemies with frightening speed to engage in deadly swordplay.",
        "studying", "Studying",
        {"grazes", "cuts", "slices", "slashes", "stabs"}},
    {"Devoted to the rites of Lilith, the Lilith Priest carries an array of dark relics that jangle as $HESHE walks, each one a vessel of infernal power $HESHE can direct against those who stand in $HISHER way.",
        "praying over", "Praying",
        {"cuts", "slices", {0}}},
    {"A daughter of Lilith born to occult fire, the Bat Lilith's eyes glow like embers and $HISHER hands radiate a terrible heat. $HESHE channels the dark flame of $HISHER lineage against any who dare oppose $HIMHER.",
    ...
    {"A small and detestable spirit, the Shikutz flickers with corrupt light in the gloom, $HISHER beating wings accompanied by intermittent peals of wicked laughter. What $HESHE lacks in strength, $HESHE more than compensates with cunning and a host of mischievous abilities.",
    ...
    {"This trickster demon moves with astonishing speed and delights in stealing from $HISHER enemies and blinking away.",
        ...
        {"slices", "cuts", {0}}},
    {"The Za'am is divine wrath turned to flesh, $HISHER moist wings beating thunderously in the darkness. Once an instrument of heavenly judgment, $HESHE has become rage incarnate, striking down all in $HISHER path without distinction.",
    ...
    {"This unholy specter stalks the deep places of the earth without fear, impervious to conventional attacks.",
        ...
        {"hits", {0}}},
    {"The Shikuz Tofet is an abomination of the deepest places, a seething nightmare of fleshy tentacles that slinks through the bowels of the earth. $HISHER incredible strength and relentless regeneration make $HIMHER among the most fearsome entities in the dungeon.",
    ...
    {"The Tanin Gadol is the great serpent of the deep places, $HISHER immense form belying $HISHER lightning-quick strikes. An undying furnace of white-hot fire burns within $HISHER ancient scales, and $HISHER very breath is annihilation.",
        "consuming", "Consuming",
        {"claws", "tail-whips", "bites", {0}}},

    {"Taller, stronger and crueler than the Shedim it commands, the Shed-Adon has claimed demonic favor through $HISHER brutal dominion. $HESHE can summon $HISHER kin into battle with a terrible war cry.",
        "chanting over", "Chanting",
