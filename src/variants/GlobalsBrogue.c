...
checkpointText checkpointTexts_Brogue[] = {
    {1, {
...
const hordeType hordeCatalog_Brogue[] = {
    ...
    {MK_PIXIE,          1,      {MK_IMP},                               {{1, 2, 1}},                    14,     21,     10,     0,          0,                  HORDE_LEADER_CAPTIVE | HORDE_NEVER_OOD},
    ...
    // bosses
    {MK_GOBLIN_CHIEFTAN,2,      {MK_GOBLIN_MYSTIC, MK_GOBLIN},          {{1,1,1}, {2,3,1}},             2,      10,     50,     0,          0,                  HORDE_MACHINE_BOSS},
...
#define BROGUE_VERSION_STRING "Cult of the Ziz " STRINGIFY(BROGUE_MAJOR) "." STRINGIFY(BROGUE_MINOR) "." STRINGIFY(BROGUE_PATCH) BROGUE_EXTRA_VERSION
...
void initializeGameVariantBrogue() {
    ...
    checkpointTexts = checkpointTexts_Brogue;
}
